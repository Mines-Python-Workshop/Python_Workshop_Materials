 ...
 * [0.0.1 Install python](#installing-python)
 * [0.0.2 Install a package manager](#installing-a-package-manager)
 * [0.0.3 Install jupyter notebooks](#installing-jupyter-notebooks)
 * [0.0.4 Install a text editor](#installing-a-text-editor)
